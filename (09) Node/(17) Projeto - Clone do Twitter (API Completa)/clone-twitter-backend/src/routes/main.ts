...
// Rotas implementadas por mim
mainRouter.put('/user/avatar', verifyJWT, userController.updateUserAvatar)
mainRouter.put('/user/cover', verifyJWT, userController.updateUserCover)
