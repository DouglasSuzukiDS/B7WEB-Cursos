...
export namespace Prisma {
  ...
  */
  ...
  export type ProductMetadataOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "productId" | "categoryMetadata" | "metadataValueId" | "createdAt" | "updatedAt", ExtArgs["result"]["productMetadata"]>
  ...
  interface ProductMetadataFieldRefs {
    ...
    readonly categoryMetadata: FieldRef<"ProductMetadata", 'String'>
  ...
  export type MetadataValueOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"in" | "label" | "categoryMetadataId" | "createdAt" | "updatedAt", ExtArgs["result"]["metadataValue"]>
  ...
  export interface MetadataValueDelegate<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs, GlobalOmitOptions = {}> {
     ...
     * 
     * // Only select the `in`
     * const metadataValueWithInOnly = await prisma.metadataValue.findMany({ select: { in: true } })
     * 
     */
     ...
     * })
     * 
     * // Create many MetadataValues and only return the `in`
     * const metadataValueWithInOnly = await prisma.metadataValue.createManyAndReturn({
     *   select: { in: true },
     *   data: [
     *     // ... provide data here
     *   ]
     ...
     * })
     * 
     * // Update zero or more MetadataValues and only return the `in`
     * const metadataValueWithInOnly = await prisma.metadataValue.updateManyAndReturn({
     *   select: { in: true },
     *   where: {
     *     // ... provide filter here
     *   },
  ...
  interface MetadataValueFieldRefs {
    readonly in: FieldRef<"MetadataValue", 'String'>
  ...
  export type ProductMetadataWhereInput = {
    ...
    categoryMetadata?: StringFilter<"ProductMetadata"> | string
  ...
  export type ProductMetadataScalarWhereWithAggregatesInput = {
    ...
    categoryMetadata?: StringWithAggregatesFilter<"ProductMetadata"> | string
  ...
  export type MetadataValueWhereInput = {
    ...
    in?: StringFilter<"MetadataValue"> | string
  ...
  export type MetadataValueScalarWhereWithAggregatesInput = {
    ...
    in?: StringWithAggregatesFilter<"MetadataValue"> | string
  ...
  export type ProductMetadataUpdateInput = {
    categoryMetadata?: StringFieldUpdateOperationsInput | string
  ...
  export type MetadataValueUpdateInput = {
    in?: StringFieldUpdateOperationsInput | string
    label?: StringFieldUpdateOperationsInput | string
    createdAt?: DateTimeFieldUpdateOperationsInput | Date | string
    updatedAt?: DateTimeFieldUpdateOperationsInput | Date | string
