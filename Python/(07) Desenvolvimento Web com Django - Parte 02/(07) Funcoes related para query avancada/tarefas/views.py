...
def home(request):
   lista = Tarefa.objects.select_related('usuario', 'usuario__perfil').all() # Faz uma consulta no DB para trazer todas as tarefas ja com o nome de usuario e o perfil
